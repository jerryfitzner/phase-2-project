# The Relief Request App

The relief request app is a simple single page application which was built using REACT. There are many improvements which will added as time goes by. 
